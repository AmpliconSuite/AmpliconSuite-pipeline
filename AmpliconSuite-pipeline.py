...
def run_AA(amplified_interval_bed, AA_outdir, sname, args):
    ...
    # AA 1.5+ can use either Mosek or Clarabel for CN optimization via --solver. When Mosek is unavailable or
    # fails during optimization, AA retries with Clarabel. Feature-detect since older AA versions lack --solver.
